	...
	<div id="page">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-left menu-1">
                            <ul>
                                ...
                                <li class="active"><a href="men.php">Мужская обувь</a></li>
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="index.php">Главная</a></span> / <span>Мужская обувь</span></p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col">
						...
						<div class="menu text-center">
							<p>Самые новые модели мужской обуви популярных брендов</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4 text-center">
						<div class="featured">
							<div class="featured-img featured-img-2" style="background-image: url(images/povsednevMen.jpg);">
								<h2>Повседневная</h2>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 offset-sm-2 text-center colorlib-heading colorlib-heading-sm">
						<h2>Все модели мужской обуви</h2>
					</div>
				</div>
				<div class="row row-pb-md">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            <form method="post" action="addCart/1.php">
								<img src="images/men1.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							<div class="desc">
								<h2>Классические туфли "Гучи"</h2>
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            <form method="post" action="addCart/2.php">
								<img src="images/men2.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							<div class="desc">
								<h2><a href="#">Высокие кеды "Блекбери"</a></h2>
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            <form method="post" action="addCart/3.php">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            <form method="post" action="addCart/4.php">
                            <img src="images/item-4.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							<div class="desc">
								<h2><a href="#">Спортивыне кроссовки "Месс"</a></h2>
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            <form method="post" action="addCart/5.php">
								<img src="images/men3.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
                            <div class="desc">
                                <h2><a href="#">Классические туфли "Масса"</a></h2>
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            <form method="post" action="addCart/6.php">
                            <img src="images/item-6.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							<div class="desc">
								<h2><a href="#">Спортивные кроссовки "Масса"</a></h2>
								<span class="price">125.00 p.</span>
                                <button type="submit" class="btn btn-success"  >Добавить</button>
							</div>
                            </form>
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            <form method="post" action="addCart/8.php">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							...
							<div class="desc">
								<h2><a href="#">Мужские полуботы "Марел"</a></h2>
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
								<img src="images/men4.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							<div class="desc">
								<h2><a href="#">Туфли "Колхозники"</a></h2>
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
								<img src="images/item-12.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">a>
							<div class="desc">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
                            ...
                            <div class="desc">
                                <h2><a href="#">Кроссовки "Найк Аир Аптемпо"</a></h2>
                                <span class="price">349.00 p.</span>
                                <button type="submit" class="btn btn-success"  >Добавить</button>
                            </div>
						</div>
					</div>
